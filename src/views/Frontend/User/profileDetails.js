      ...
      <div className="px-4">
                ...
                <div className="text-center mt-5">
                  <h3>
                    ...
                    <span className="font-weight-light">, {differenceInYears(
                        new Date(),
                  ...
                  <div className="text-capitalize font-weight-bold ml-0 mt-5" style={{flex: 1 }} >
                     more informations:
                  </div>
                  <div className="text-capitalize font-weight-bold ml-0 mt-5" style={{flex: 1 }}>
                     earned badge:
                    ...
                    <Row className="justify-content-right">
                      ...
                      <div className="progress-wrapper">
                          <div className="progress-info" >
                            ...
                            <div className="progress-label" >
                              <span style={{ background:"#e9ecef",opacity: 0.6,borderRadius: "30px",padding: "0.25rem 1rem"}}>LEVEL: {props.evaluation.lvl}</span>
                            </div>  
                            </div>
                        ...
                        <div className="progress-wrapper">
                          <div className="progress-info">
                            <div className="progress-label" >
                              <span style={{ background:"#e9ecef",opacity: 0.6,borderRadius: "30px",padding: "0.25rem 1rem"}}>Progress completed</span>
                            </div>
                            <div className="progress-percentage">
                              ...
                              badge.map((badge) => (
                                <>
                                  <div className="img-wrapper mr-2 mb-2">
                                    ...
                                    <div className="details"  onClick={()=>{simpletoggleModal() ; selectedEvent(badge._id)}}>
                                      Details
                                    </div>
                                  </div>
                                   <SimpleModal  
